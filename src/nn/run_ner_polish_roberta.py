...
from tokenizers import SentencePieceBPETokenizer, RobertaProcessing
...
from src.bert.transformer_ner.utils_ner import convert_examples_to_features, get_labels, read_examples_from_file
...
def main():
    ...
    #     **tokenizer_args,
    # )
    tokenizer = SentencePieceBPETokenizer(f"{args.model_name_or_path}/vocab.json", f"{args.model_name_or_path}/merges.txt")
