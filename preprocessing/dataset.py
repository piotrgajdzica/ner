...
from preprocessing.title_mapper import TitleMapper


class Token:
    def __init__(self, token, lemma, space, tags, entity, entity_wikidata_id, nkjp_class=None, start_tag=None):
    ...
    def write_to_file(self, file):
        file.write('%s\t%s\t%s\t%s\t%s_%s\n' % (self.token, self.lemma, self.space, self.tags, self.start_tag or '',
                                                self.nkjp_class or ''))
...
class Article:
    ...
    def annotate_title(self, title, nkjp_class):
    ...
    for article in articles:
        if article.is_valid():
            ...
            if wikidata_json is not None and wikidata_json['id'] is not None:
                ...
                if nkjp_class is not None:
                    article.annotate_title(wikidata_json['title'], nkjp_class)
